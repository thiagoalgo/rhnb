...
class Custom extends ThemeBase
{
    ...
    public function table(): Table
    {
        return Theme::table('min-w-full dark:bg-slate-800')
            ...
            ->trBody('odd:bg-slate-100 hover:odd:bg-slate-200 border-b border-pg-primary-100 dark:border-pg-primary-600 hover:bg-pg-primary-50 dark:bg-pg-primary-800 dark:hover:bg-pg-primary-700')
